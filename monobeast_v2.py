...
# flags.DEFINE_string('sc2_run_config', 'default_value', 'Description for sc2_run_config') # TODO Change this
...
def init_flags_for_multiprocessing(argv):
    ...
    if not flags.FLAGS.is_parsed():
        flags.FLAGS(argv)  # Parse the flags again inside the subprocess
...
def main_func(argv):
    ...
    # Step 2: Initialize the SC2 environment and proceed with training/testing
    start = time.time()
    main(flags)
